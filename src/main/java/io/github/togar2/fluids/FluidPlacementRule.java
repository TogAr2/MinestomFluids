...
public class FluidPlacementRule extends BlockPlacementRule {
	...
	public @NotNull Block blockUpdate(@NotNull UpdateState updateState) {
		...
		if (waterlogged == null || waterlogged.equals("true")) {
			MinestomFluids.scheduleTick((Instance) updateState.instance(), new BlockVec(updateState.blockPosition()), updateState.currentBlock());
		}
	...
	public @NotNull Block blockPlace(@NotNull PlacementState placementState) {
		...
		if (waterlogged == null || waterlogged.equals("true")) {
			MinestomFluids.scheduleTick((Instance) placementState.instance(), new BlockVec(placementState.placePosition()), placementState.block());
		}
